...
### GUI / Browser Cleanup
- Safari などのブラウザや GUI を使って検証した場合、作業完了前に Codex が自分で一時ウィンドウ・タブ・関連プロセスを片付ける
- スクリーンショット、ダウンロード、一時ファイルなど検証由来の生成物が不要なら残さない
- OS ダイアログや権限制約などで完全に片付けられなかった場合のみ、人間確認事項として短く報告する
